(function () {
  ...
  function calculateDividendSummaryV62(rows) {
  ...
  function renderEntryQuickStatsV62() {
    ...
    const summary = calculateDividendSummaryV62(dividendRows);
  ...
  try {
    ...
    if (!originalRender.__dividendV62) {
      render = function renderWithDividendV62() {
        originalRender();
        renderEntryQuickStatsV62();
      };
      render.__dividendV62 = true;
    }
  } catch (error) {
