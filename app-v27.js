...
function showMenuPanel(panel) {
  ...
  dom.menuMainPanel.classList.toggle("is-hidden", showTokenSettings || showColumnSettings);
...
function registerServiceWorker() {
  ...
  navigator.serviceWorker.register("./service-worker-v27.js", { scope: "./" }).catch((error) => {
