...
function exportPortfolioCsv() {
  ...
  downloadFile(blob, `wealthtrack-google-sheets-${new Date().toISOString().slice(0, 10)}.csv`);
}
...
function handleExport(format) {
  ...
  if (format === "csv") exportPortfolioCsv();
...
function registerServiceWorker() {
  ...
  navigator.serviceWorker.register("./service-worker-v31.js", { scope: "./" }).catch((error) => {
