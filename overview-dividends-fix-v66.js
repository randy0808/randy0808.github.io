(function () {
  ...
  function calculateDividendSummaryV66(rows) {
  ...
  function renderEntryQuickStatsV66() {
    ...
    const summary = calculateDividendSummaryV66(dividendRows);
  ...
  try {
    ...
    if (!originalRender.__dividendV66) {
      render = function renderWithDividendV66() {
        originalRender();
        renderEntryQuickStatsV66();
      };
      render.__dividendV66 = true;
    }
  } catch (error) {
