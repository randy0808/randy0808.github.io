(function () {
  ...
  function calculateDividendSummaryV68(rows) {
  ...
  function renderEntryQuickStatsV68() {
    ...
    const summary = calculateDividendSummaryV68(dividendRows);
  ...
  try {
    ...
    if (!originalRender.__dividendV68) {
      render = function renderWithDividendV68() {
        originalRender();
        renderEntryQuickStatsV68();
      };
      render.__dividendV68 = true;
    }
  } catch (error) {
